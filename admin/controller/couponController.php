        ...
        if(isset($coupon_id) && $coupon_id == ""){
            ...
            if($return){
                ...
                foreach ($cuponUser as $key=>$users){
                    ...
                    $subject = 'Techoutorders offering a discount of '.$amount;
                    $body 	 = '<p>Dear '.$users["full_name"].',</p><p>You have been offered '. $amount.' discount on your order in Techoutorders. 
                        ...
                        <p>Best Regards</p><p>Techoutorders</p><p>Note: Please Do not reply this email.</p>';
            ...
            if($return){
                ...
                foreach ($cuponUser as $key=>$users){
                    ...
                    $body 	 = '<p>Dear '.$users["full_name"].'</p>You have been offered '. $amount.' discount on your order in OurBurritoBrothers. 
                        ...
                        Best Regards</p><p><b>Techoutorders</b></p><p>Note: Please Do not reply this email.</p>';
